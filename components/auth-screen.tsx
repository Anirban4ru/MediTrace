...
export function AuthScreen() {
  ...
  return (
    <div className="grid-canvas flex min-h-screen items-center justify-center bg-[#F4F4F6] p-4">
      <div className="w-full max-w-md">
        <div className="mb-6 flex items-center justify-center gap-3">
          <div className="brutal-border brutal-shadow-sm flex h-12 w-12 items-center justify-center bg-black text-white">
