    ...
    <div className="border shadow-ambient bg-card rounded-xl p-6 bg-base flex flex-col items-center max-w-sm mx-auto my-6 print-container">
      ...
      <div className="w-full space-y-2 mb-6">
        <div className="flex justify-between border-b border-black/10 pb-1">
          <span className="mono-data text-[10px] text-ink/60">Product</span>
          <span className="font-bold text-[12px] uppercase">{productName}</span>
        </div>
        <div className="flex justify-between border-b border-black/10 pb-1">
          <span className="mono-data text-[10px] text-ink/60">Batch ID</span>
          <span className="font-bold text-[12px] mono-data">{batchId}</span>
        </div>
        <div className="flex justify-between border-b border-black/10 pb-1">
          <span className="mono-data text-[10px] text-ink/60">GS1 Serial</span>
      ...
      <button 
        onClick={handlePrint}
        className="print-hide w-full flex items-center justify-center gap-2 border-2 border-black bg-[var(--ink)] text-[var(--bg)] px-4 py-3 text-[12px] font-bold uppercase tracking-[0.14em] active:scale-[0.98] transition-transform hover:bg-[#102A43]"
      >
